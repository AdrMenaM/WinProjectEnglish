...
{
    public partial class frmAct_2_3 : Form
    {
        ...
        private void btnPlay1_Click(object sender, EventArgs e)
        {
            ...
            //mPath += @"\Media\Audio\ModesOfTransportation\How_to_Pronounce_Rocket.wav"; //Concatena la direccion específica del sonido.
            ////Se usa un objeto SoundPlayer que permite reproducir archivos .wav 
            SoundPlayer sound = new SoundPlayer(Properties.Resources.How_to_Pronounce_Rocket);
        ...
        private void btnPlay2_Click(object sender, EventArgs e)
        {
            ...
            //mPath += @"\Media\Audio\ModesOfTransportation\How_to_Pronounce_plane.wav";
            ////Se usa un objeto SoundPlayer que permite reproducir archivos .wav 
            SoundPlayer sound = new SoundPlayer(Properties.Resources.How_to_Pronounce_plane);
            sound.Play();       //Reproduce el sonido del objeto creado.
        }
        ...
        {
            //mPath = System.Environment.CurrentDirectory;
            //mPath += @"\Media\Audio\ModesOfTransportation\How_to_Pronounce_Balloon.wav";
            ////Se usa un objeto SoundPlayer que permite reproducir archivos .wav 
            SoundPlayer sound = new SoundPlayer(Properties.Resources.How_to_Pronounce_Balloon);
            sound.Play();       //Reproduce el sonido del objeto creado.
        }
        ...
        {
            //mPath = System.Environment.CurrentDirectory;
            //mPath += @"\Media\Audio\ModesOfTransportation\How_to_Pronounce_ATV.wav";
            ////Se usa un objeto SoundPlayer que permite reproducir archivos .wav 
            SoundPlayer sound = new SoundPlayer(Properties.Resources.How_to_Pronounce_ATV);
            sound.Play();       //Reproduce el sonido del objeto creado.
        }
        ...
        {
            //mPath = System.Environment.CurrentDirectory;
            //mPath += @"\Media\Audio\ModesOfTransportation\How_to_Pronounce_Motorboat.wav";
            ////Se usa un objeto SoundPlayer que permite reproducir archivos .wav 
            SoundPlayer sound = new SoundPlayer(Properties.Resources.How_to_Pronounce_Motorboat);
            sound.Play();       //Reproduce el sonido del objeto creado.
        }
        ...
        {
            //mPath = System.Environment.CurrentDirectory;
            //mPath += @"\Media\Audio\ModesOfTransportation\How_to_Pronounce_helicopter.wav";
            //Se usa un objeto SoundPlayer que permite reproducir archivos .wav 
            SoundPlayer sound = new SoundPlayer(Properties.Resources.How_to_Pronounce_helicopter);
            sound.Play();       //Reproduce el sonido del objeto creado.
        }
        ...
        {
            //mPath = System.Environment.CurrentDirectory;
            //mPath += @"\Media\Audio\ModesOfTransportation\How_to_Pronounce_ship.wav";
            //Se usa un objeto SoundPlayer que permite reproducir archivos .wav 
            SoundPlayer sound = new SoundPlayer(Properties.Resources.How_to_Pronounce_ship);
            sound.Play();       //Reproduce el sonido del objeto creado.
        }
        ...
        {
            //mPath = System.Environment.CurrentDirectory;
            //mPath += @"\Media\Audio\ModesOfTransportation\How_to_Pronounce_Pickup.wav";
            //Se usa un objeto SoundPlayer que permite reproducir archivos .wav 
            SoundPlayer sound = new SoundPlayer(Properties.Resources.How_to_Pronounce_Pickup);
            sound.Play();       //Reproduce el sonido del objeto creado.
        }
        ...
        {
            //mPath = System.Environment.CurrentDirectory;
            //mPath += @"\Media\Audio\ModesOfTransportation\How_to_Pronounce_Submarine.wav";
            //Se usa un objeto SoundPlayer que permite reproducir archivos .wav 
            SoundPlayer sound = new SoundPlayer(Properties.Resources.How_to_Pronounce_Submarine);
            sound.Play();       //Reproduce el sonido del objeto creado.
        }
        ...
        {
            this.Close();   //Cierra el formulario actual.
            frmAct_2_3 objFrm = new frmAct_2_3();       //Crea un nuevo formulario de esta misma actividad.
